...
export default function Layout({ children }: LayoutProps) {
  ...
  <ul className="flex space-x-6">
    <li>
      <Link legacyBehavior href="/" className="hover:text-blue-200 transition-colors">
        Home
      </Link>
    </li>
    <li>
      <Link legacyBehavior href="/matches" className="hover:text-blue-200 transition-colors">
        Matches
      </Link>
    </li>
    <li>
      <Link legacyBehavior href="/points-table" className="hover:text-blue-200 transition-colors">
        Points Table
      </Link>
    </li>
    <li>
      <Link legacyBehavior href="/stats" className="hover:text-blue-200 transition-colors">
        Stats
      </Link>
    </li>
  </ul>
